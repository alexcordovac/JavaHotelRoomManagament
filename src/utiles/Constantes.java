...
public class Constantes {
    public static final Color COLOR_PRIMARIO = new Color(69, 157, 140);
    public static final Color COLOR_NEGRO = new Color(64, 63, 62);
    public static final Color COLOR_GRIS = new Color(230, 230, 230);
